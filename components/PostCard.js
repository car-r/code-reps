...
const PostCard = ({ post }) => {
    console.log(post)
    return (
        <div className='bg-gray-700 bg-opacity-30 text-gray-400 rounded-lg p-0 lg:p-8 pb-12 mb-8'>
            ...
            hover:text-blue-400 w-11/12 mx-auto text-2xl md:text-3xl font-semibold'>
            ...
            <div className='text-center'>
                <Link href={`/post/${post.slug}`}>
                    <span className='text-white transition duration-500 transform hover:-translate-y-1 inline-block bg-pink-600 text-lg font-medium rounded-full px-8 py-3 cursor-pointer'>
                        Continue Reading
                    </span>
                </Link>
            </div>
